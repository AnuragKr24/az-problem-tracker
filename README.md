...
A lightweight **Chrome Extension** built with **HTML, CSS, and JavaScript** to manage bookmarks exclusively for problems in [maang.in](https://maang.in/).  
...
## 🚀 Features
- 📌 Add bookmarks directly while browsing problems in [maang.in](https://maang.in/).
